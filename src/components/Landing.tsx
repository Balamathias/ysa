...
const Landing = () => {
  return (
    <MaxWrapper className="justify-center h-max">
        <div className="flex flex-col md:flex-row md:gap-x-6 h-full justify-between my-auto">
          ...
          <div className="flex basis-1/2 flex-col space-y-3 py-2 px-2">
            ...
            <div className="flex flex-row items-center space-x-4 py-3 sm:py-5">
              <Button className="bg-primary flex items-center justify-center space-x-1 text-white py-6 px-8 rounded-xl">
